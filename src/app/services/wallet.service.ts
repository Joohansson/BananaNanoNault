...
export class WalletService {
  ...
  generateExportUrl() {
    ...
    return `https://joohansson.github.io/BananoNanoNault/import-wallet#${base64Data}`;
  }
  ...
  async processPendingBlocks() {
    ...
    if (newHash) {
      ...
      this.notifications.sendSuccess(
        `Successfully received ${receiveAmount.isZero() ? '' : receiveAmount.toFixed(6)} Banano!`, { identifier: 'success-receive' });
